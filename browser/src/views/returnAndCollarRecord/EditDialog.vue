    ...
    <el-form :model="fillForm" :rules="rules" ref="fillForm">
      <div class="form-group col-sm-12">
        <el-form-item :label="$t('employeeName')" prop="employeeName">
          <el-input v-model="fillForm.employeeName"></el-input>
        </el-form-item>
      </div>
      ...
      <div class="form-group col-sm-12">
        <el-form-item :label="$t('collarCardTotal')" prop="collarCardTotal">
          <el-input v-model="fillForm.collarCardTotal"></el-input>
        </el-form-item>
      </div>

      <div class="form-group col-sm-12">
        <el-form-item :label="$t('returnCardTotal')" prop="returnCardTotal">
          <el-input v-model="fillForm.returnCardTotal"></el-input>
        </el-form-item>
      </div>
    </el-form>
